...
dependencies {
    ...
    implementation("io.micronaut.grpc:micronaut-grpc-runtime:3.1.0")
    ...
    testImplementation("io.micronaut:micronaut-http-client:3.1.4")

}


application {
    mainClass.set("br.com.samuellfa.ApplicationKt")
}
java {
